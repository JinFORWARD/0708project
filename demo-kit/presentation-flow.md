...
定位：两位成员都是新人，展示重点放在“我们怎么理解、怎么验证、看到什么现象”。主线展示可以只展示源码、配置、短报告和指标清单；一键自动测试脚本已修复，可作为备用展示手段。
...
> 主展示先以固定实验参数、已有日志和报告结论为准。如果时间允许，可以运行备用脚本 `demo-kit/run-demo-tests.ps1`。该脚本已完成默认参数验证，最新成功数据目录是 `observability/20260709-010940-9e9o/`。
