...
& .\scripts\start-backend.ps1 -PythonExe 'python' 2>&1 | Tee-Object -FilePath 'D:\Workspace\01-onboarding-training\2026-07-08-gateway-tech-intro\0708project\observability\20260709-110434-9e4o\backend.log'
